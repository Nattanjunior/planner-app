...
export default function Index() {
  ...
  const [selectedDates, setSelectdeDates] = useState({} as DatesSelected)
  ...
  function handleSelectedStepForm(selectedDay: DateData){
  ...
  function handleAddEmail(){
    ...
    if(emailAlreadyExists){
      return Alert.alert('Convidado', "E-mail já foii adicionado!" ) 
    }
 ...
 return (
   <View className='flex-1 items-center justify-center px-5'>
    ...
    >
      <View className='gap-2 mt-4'>
        <Calendar 
         ...
         onDayPress={handleSelectedStepForm}
    ...
    >
      ...
      <View className='my-2 flex-col gap-2 border-b border-zinc-800 py-5 items-start'>
